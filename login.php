...
<head>
<meta charset="utf-8">
<title>IMMNewsNetwork login Page</title>
	...
	<div>
	    <header>
			   <img class="logo" src="images/logo.jpg" alt="IMM News Network"></img><h1>IMM News Network</h1>
			     ...
			     <nav id="nav"> 
			     <ul>
			            <li><a href="immnewsnetwork-revised.html"   class="texts" width=30% align=left ><b>home</b></a></li>
		...
		<section class="texts" style="font-size:20px;">
			...
			<form action="loginProcess.php" method="post">
				...
				<table align="center"  width=60% height=60%  bgcolor="lightgrey"  padding=5px margin=5px><table align="center"  width=60% height=60%  bgcolor="lightgrey"  padding=5px margin=5px>
					<tr>
						<td align= right class="texts" >
							<label for="username" >user name &nbsp;</label>
						</td>
						<td  class="texts">
							<input  type="text" name="username" maxlength="50" size="30" placeholder="Enter Username or Email" required>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="texts">
							<input  type="text" name="password" maxlength="50" size="6" placeholder="6 charaters">
						</td>
					</tr>
					...
					<!--<tr>
						<td style="ackground-color:#f1f1f1; text-align:left; ">
							<label>
				     			 <input type="checkbox" checked="checked" name="remember"> remember me
				    		</label>
						</td>
						<td style="ackground-color:#f1f1f1; text-align:right; ">
							<label>
